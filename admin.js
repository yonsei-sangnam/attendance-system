...
<head>
  ...
  <style>
    * { box-sizing:border-box; margin:0; padding:0; }
    body { font-family:-apple-system,'Malgun Gothic',sans-serif; background:#656668; color:#1d1d1f; padding:16px; }
    ...
    #mapPreview { width:100%; height:200px; border-radius:10px; background:#656668; border:1.5px solid #e5e5e7; display:flex; align-items:center; justify-content:center; font-size:13px; color:#86868b; margin-top:10px; }
    #msg { font-size:13px; margin-top:8px; min-height:20px; }
  </style>
</head>
<body>
  <div style="background:#003876;padding:12px 20px;margin:-16px -16px 20px -16px;"><img src="data:image/png;base64," alt="연세대학교 상남경영원" style="height:44px;display:block;"></div>
<div class="container">
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .stat { background: #656668; border-radius: 8px; padding: 12px 16px; text-align: center; min-width: 80px; }
    ...
    th { text-align: left; padding: 8px 10px; background: #656668; color: #86868b; font-weight: 500; font-size: 12px; position: sticky; top: 0; }
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    table { width: 100%; border-collapse: collapse; font-size: 13px; }
    th { text-align: left; padding: 8px 10px; background: #656668; color: #86868b; font-weight: 500; font-size: 12px; }
    td { padding: 8px 10px; border-top: 1px solid #f0f0f0; }
    tr:hover { background: #fafafa; }
    ...
    .stats { display: flex; gap: 12px; flex-wrap: wrap; margin-bottom: 16px; }
    .stat { background: #656668; border-radius: 8px; padding: 10px 14px; text-align: center; min-width: 70px; }
...
async function loadRegLog() {
  try {
    ...
    html += '<tr><th style="text-align:left;padding:6px 8px;background:#656668;font-size:12px;">이름</th><th style="text-align:left;padding:6px 8px;background:#656668;font-size:12px;">전화번호</th><th style="text-align:left;padding:6px 8px;background:#656668;font-size:12px;">등록 시각</th><th style="text-align:left;padding:6px 8px;background:#656668;font-size:12px;">상태</th></tr>';
...
<div id="regTokenModal" style="display:none;position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);z-index:1000;align-items:center;justify-content:center;">
  <div style="background:#fff;border-radius:16px;padding:28px 24px;max-width:420px;width:90%;text-align:center;box-shadow:0 8px 32px rgba(0,0,0,0.2);">
    ...
    <div style="margin-top:14px;display:flex;gap:8px;">
      <input id="regTokenUrl" type="text" readonly style="flex:1;padding:10px;border:1px solid #d2d2d7;border-radius:8px;font-size:12px;color:#444;background:#656668;">
    ...
    <button onclick="document.getElementById('regTokenModal').style.display='none'" style="margin-top:16px;width:100%;padding:12px;background:#656668;color:#1d1d1f;border:none;border-radius:8px;font-size:14px;cursor:pointer;">닫기</button>
  </div>
</div>
</body>
</html>`;
...
function editSession(sessionId) {
  ...
  let html = '<div style="background:#656668;padding:16px;border-radius:10px;margin-top:12px;">';
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .back-link { font-size: 13px; color: #1a73e8; text-decoration: none; }
    .info-box { background: #e8f0fe; border-radius: 8px; padding: 14px 18px; margin-bottom: 16px; font-size: 13px; color: #1a73e8; line-height: 1.8; }
    .step-box { background: #656668; border-radius: 8px; padding: 12px 16px; margin: 8px 0; font-size: 13px; line-height: 1.8; }
...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    body { font-family: -apple-system, 'Malgun Gothic', sans-serif; background: #656668; padding: 20px; }
...
<body>
  <div style="background:#003876;padding:12px 20px;margin:-20px -20px 20px -20px;"><img src="data:image/png;base64," alt="연세대학교 상남경영원" style="height:44px;display:block;"></div>
  <div class="header">
